...
const UserCard = ({ user }: { user: IUser }) => {
  return (
    <Link
      to={`/profile/${user.$id}`}
      className="flex flex-col items-center justify-center p-5 lg:p-7 border border-dark-4 rounded-3xl bg-dark-2 w-full min-w-[200px] hover:border-dark-3 transition-all duration-300 hover:shadow-lg hover:shadow-black/20"
    >
      <img
